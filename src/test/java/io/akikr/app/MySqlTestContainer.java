...
public abstract class MySqlTestContainer {
    ...
    @ServiceConnection
    static final MySQLContainer<?> mySqlContainer = new MySQLContainer<>(DockerImageName.parse("mysql:8.4.8"))
    ...
    static {
        ...
        mySqlContainer.followOutput(new Slf4jLogConsumer(LoggerFactory.getLogger(MySqlTestContainer.class)));
