...
public class StoreServiceImpl implements StoreService {
    ...
    public ResponseEntity<PagedResponse<StoreSearchResponse>> listStores(
        ...
        try {
            ...
            var storeSpecification =
                    StoreSpecifications.withOptionalFilters(tenantId, fromDate, toDate, status, platform, code, domain);
    ...
    public ResponseEntity<PagedResponse<StoreSearchResponse>> searchStores(
        ...
        try {
            ...
            var storeSpecification = StoreSpecifications.withSearchFilters(tenantId, websiteId, code, domain);
            var storePage = storeProcessor.findBySpecification(storeSpecification, pageable);
            log.info(
    ...
    @Override
    public ResponseEntity<StoreResponse> getStoreById(String orgId, String websiteId) throws StoreException {
    ...
    @Override
    public ResponseEntity<StoreUpdateResponse> updateStore(String orgId, String websiteId, StoreUpdateRequest request)
            throws StoreException {
        ...
        try {
            ...
            var storeId = UUID.fromString(websiteId);
            var existingStore = storeProcessor
    ...
    @Override
    public ResponseEntity<StorePatchResponse> patchStore(String orgId, String websiteId, StorePatchRequest request)
            throws StoreException {
    ...
    public ResponseEntity<Void> deleteStore(String orgId, String websiteId) throws StoreException {
        ...
        try {
            ...
            var storeId = UUID.fromString(websiteId);
            Store existingStore = storeProcessor
                    .findByStoreIdAndTenantId(storeId, tenantId)
                    .orElseThrow(() -> new RuntimeException("No Store found with id: " + websiteId));
            log.debug("Store found for storeId[{}]", websiteId);
        ...
        try {
            return storeProcessor
                    ...
                    .orElseThrow(() -> new RuntimeException(
                            "Store with id:[ " + storeId + "] not found or does not belong to orgId:[" + orgId + "]"));
        } catch (NullPointerException | IllegalArgumentException e) {
            log.error(
            ...
            throw new StoreException(
                    ...
                    e,
                    "An errorDetails occurred while deactivating the website",
                    "verifyStoreBelongsToOrganization for orgId:[" + orgId + "] and storeId:[" + storeId + "]");
        }
    }
